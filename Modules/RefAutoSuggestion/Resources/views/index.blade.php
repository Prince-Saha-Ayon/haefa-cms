    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <button class="btn btn-primary btn-sm" onclick="showFormModal('Add refautosuggestion','Save');removeId()">
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="name">AutoSuggestion</label>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter AutoSuggestion">
                            </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#store_or_update_modal .modal-title').html(
                    '<i class="fas fa-edit"></i> <span>Edit refautosuggestion</span>');
