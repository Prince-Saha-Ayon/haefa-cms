          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.textbox labelName="Duration Code" name="DurationCode" id="DurationCode" required col="col-md-12"  placeholder="Enter Duration Code"/>
                    ...
                    <x-form.textbox labelName="Duration In Bangla" name="DurationInBangla" id="DurationInBangla" required col="col-md-12"  placeholder="Enter Duration In Bangla"/>
