                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="name">Drug Group</label>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Drug Group">
                            </div>
...
@include('refdruggroup::modal')
{{-- @include('refdruggroup::add-edit-modal') --}}
@endsection
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('refdruggroup.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [
            @if (permission('refdruggroup-report'))
            {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('refdruggroup.store.or.update')}}";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#view_modal .modal-title').html(
                        '<i class="fas fa-eye"></i> <span>refdruggroup</span>');
                },
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let name  = "refdruggroup";
        console.log(name);
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('refdruggroup.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('refdruggroup.bulk.delete')}}";
...
$(document).on('click', '.change_status', function () {
    ...
    let name  = $(this).data('name');
    let row   = table.row($(this).parent('tr'));
    let url   = "{{ route('refdruggroup.change.status') }}";
    Swal.fire({
    ...
    if (id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#DrugGroupCode').val(data.DrugGroupCode);
