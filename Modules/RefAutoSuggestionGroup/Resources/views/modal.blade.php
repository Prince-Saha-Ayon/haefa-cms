          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.textbox labelName="Auto Suggestion Group Code" name="RefAutoSuggestionGroupCode" id="RefAutoSuggestionGroupCode" required="required" col="col-md-12"  placeholder="Enter Auto Suggestion Group Code"/>
