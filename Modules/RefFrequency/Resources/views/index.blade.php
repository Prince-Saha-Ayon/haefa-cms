                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Frequency">
                            </div>
...
@include('reffrequency::modal')
{{-- @include('reffrequency::add-edit-modal') --}}
@endsection
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('reffrequency.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [
            @if (permission('reffrequency-report'))
            {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('reffrequency.store.or.update')}}";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#view_modal .modal-title').html(
                        '<i class="fas fa-eye"></i> <span>reffrequency</span>');
                },
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let name  = "reffrequency";
        console.log(name);
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('reffrequency.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('reffrequency.bulk.delete')}}";
...
$(document).on('click', '.change_status', function () {
    ...
    let name  = $(this).data('name');
    let row   = table.row($(this).parent('tr'));
    let url   = "{{ route('reffrequency.change.status') }}";
    Swal.fire({
    ...
    if (id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#FrequencyCode').val(data.FrequencyCode);
                $('#FrequencyInBangla').val(data.FrequencyInBangla);
