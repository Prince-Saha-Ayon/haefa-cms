...
@include('refdrugform::modal')
{{-- @include('refdrugform::add-edit-modal') --}}
@endsection
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('refdrugform.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [
            @if (permission('refdrugform-report'))
            {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('refdrugform.store.or.update')}}";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#view_modal .modal-title').html(
                        '<i class="fas fa-eye"></i> <span>refdrugform</span>');
                },
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let name  = "refdrugform";
        console.log(name);
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('refdrugform.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('refdrugform.bulk.delete')}}";
...
$(document).on('click', '.change_status', function () {
    ...
    let name  = $(this).data('name');
    let row   = table.row($(this).parent('tr'));
    let url   = "{{ route('refdrugform.change.status') }}";
    Swal.fire({
    ...
    if (id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#DrugFormCode').val(data.DrugFormCode);
