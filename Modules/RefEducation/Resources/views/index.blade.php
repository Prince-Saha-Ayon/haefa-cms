    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <button class="btn btn-primary btn-sm" onclick="showFormModal('Add education','Save');removeId()">
                    ...
                    <form id="form-filter">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="name">Education Code</label>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Education Code">
                            </div>
