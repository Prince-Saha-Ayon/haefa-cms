    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <div class="dt-entry__header">
                ...
                <button class="btn btn-primary btn-sm" onclick="showFormModal('Add refmaritalstatus','Save');removeId()">
...
@include('refmaritalstatus::modal')
{{-- @include('refmaritalstatus::add-edit-modal') --}}
@endsection
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('refmaritalstatus.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [
            @if (permission('refmaritalstatus-report'))
            {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "{{route('refmaritalstatus.store.or.update')}}";
    ...
    $(document).on('click', '.view_data', function () {
       ...
       // let date = $(this).data('date');
        if (id) {
            $.ajax({
                url: "{{route('refmaritalstatus.show')}}",
                type: "POST",
                ...
                success: function (data) {
                    ...
                    $('#view_modal .modal-title').html(
                        '<i class="fas fa-eye"></i> <span>refmaritalstatus</span>');
                },
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let name  = "refmaritalstatus";
        console.log(name);
        let row   = table.row($(this).parent('tr'));
        let url   = "{{ route('refmaritalstatus.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('refmaritalstatus.bulk.delete')}}";
...
$(document).on('click', '.change_status', function () {
    ...
    let name  = $(this).data('name');
    let row   = table.row($(this).parent('tr'));
    let url   = "{{ route('refmaritalstatus.change.status') }}";
    Swal.fire({
...
$(document).on('click', '.edit_data', function () {
    ...
    if (id) {
        $.ajax({
            url: "{{route('refmaritalstatus.edit')}}",
            type: "POST",
            data: { id: id,_token: _token},
            dataType: "JSON",
            success: function (data) {
                ...
                $('#MaritalStatusId').val(data.MaritalStatusId);
                // $('#Description').val(data.Description);
                $('#MaritalStatusCode').val(data.MaritalStatusCode);
                ...
                $('#store_or_update_modal .modal-title').html(
                    '<i class="fas fa-edit"></i> <span>Edit refmaritalstatus</span>');
