            ...
            success: function (response) {
                 ...
                 if (response.error.length > 0) {
                    ...
                    response.error.forEach(error => {
                        toastr.error('Patient Appointment Visited Failed', 'Error');
                    });
                } else {
                    // Display a success Toastr alert
                    const successCount = response.success.length;
                    // Display a success Toastr alert with the count
                    toastr.success(`${successCount} Patient(s) Appointment Visited successfully`, 'Success');
